...
const { checkNotFound, checkValidStrings } = require('../validator')

module.exports = {
    create: (req, res, next) => {
        return checkValidStrings("Parameter 'name' is empty, or contain illegal characters", [req.body.name])
    ...
    retrieve: (req, res, next) => {
        ...
        .then(checkNotFound.bind(null, `Retrive category id [${req.params._id}] not found`))
    ...
    update: (req, res, next) => {
        ...
        .then(checkNotFound.bind(null, `Update category id [${req.params._id}] not found`))
        .then(category => { 
    ...
    delete: (req, res, next) => {
        return Category.findById(req.params._id)
        .then(checkNotFound.bind(null, `Delete category id [${req.params._id}] not found`))
        .then(category => {
